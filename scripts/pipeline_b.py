...
def process_onboarding_transcript(filepath):
    ...
    update_response_text = call_llm(build_update_extraction_prompt(onboarding_transcript, v1_memo))
    ...
    changelog_response_text = call_llm(build_changelog_prompt(v1_memo, v2_memo, onboarding_transcript))
    ...
    agent_response_text = call_llm(build_agent_spec_prompt(v2_memo))
